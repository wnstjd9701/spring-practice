...
public class UploadFileRepository implements IUploadFileRepository {
	...
	private class FileMapper implements RowMapper<UploadFileVO>{
	...
	public List<UploadFileVO> getFileList(String directoryName) {
		...
		return jdbcTemplate.query(sql, new FileMapper(), directoryName);
	}
	...
	public List<UploadFileVO> getAllFileList() {
		String sql = "SELECT file_id, directory_name, file_name, file_size, " 
				...
				+ " FROM upload_file "
				+ " ORDER BY file_upload_date DESC";
		return jdbcTemplate.query(sql, new FileMapper());
	}

	@Override
	public List<UploadFileVO> getImageList(String directoryName) {
		String sql = "SELECT file_id, directory_name, file_name, file_size, file_content_type, file_upload_date, file_data "
				+ " FROM upload_file "
				+ " WHERE directory_name=? "
				+ " ORDER BY file_upload_date DESC ";
	...
	public UploadFileVO getFile(int fileId) {
		String sql = "SELECT file_id, directory_name, file_name, file_size, file_content_type, file_data FROM upload_file WHERE file_id=?";
