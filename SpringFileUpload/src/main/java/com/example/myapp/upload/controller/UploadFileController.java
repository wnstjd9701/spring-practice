...
import com.example.myapp.upload.IUploadFileService;
import com.example.myapp.upload.UploadFileVO;
...
public class UploadFileController {
	...
	public String getImageList(@RequestParam(value="dir", required=false, defaultValue="/images") String directoryName, Model model) {
		model.addAttribute("fileList", uploadService.getImageList(directoryName));
